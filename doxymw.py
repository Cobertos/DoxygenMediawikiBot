...
def main():
    ...
    if option["command"] == "update" or option["command"] == "cleanup":
        #Delete all the pages in the coding document category
        ...
        #Find all the transclusion pages and delete the ones that only redirect the user
