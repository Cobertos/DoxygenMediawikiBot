...
config["mediaWiki_docsCategory"] = "DoxyMWBot DoxygenDocs" #The category name to use for the doxygen docs
...
config["mediaWiki_transclusionCategory"] = "DoxyMWBot TransclusionDocs"
